        ...
        <section className={styles.social_media_section}>
           ...
           <div className={styles.social_media_container}>
              ...
              <div className={`${styles.social_media_logo_wrapper} ${styles.instagramSVG_wrapper}`}>
                <Link href='https://www.instagram.com/_steve_vie/' target='_blank'><Image src={ instagramSVG } className={`${styles.social_media} ${styles.instagramSVG}`} alt='Instagram-Logo' /></Link>
              </div>

              <div className={`${styles.social_media_logo_wrapper} ${styles.facebookSVG_wrapper}`}>
                <Link href='https://www.facebook.com/barstevie/' target='_blank'><Image src={ facebookSVG } className={`${styles.social_media} ${styles.facebookSVG}`} alt='Facebook-Logo' /></Link>
              </div>

              <div className={`${styles.social_media_logo_wrapper} ${styles.githubSVG_wrapper}`}>
                <Link href='https://github.com/wkddevelopment' target='_blank'><Image src={ githubSVG } className={`${styles.social_media} ${styles.githubSVG}`} alt='Github-Logo' /></Link>
              </div>

              <div className={`${styles.social_media_logo_wrapper} ${styles.linkedinSVG_wrapper}`}>
                <Link href='https://www.linkedin.com/in/stefan-bartl-660556112/' target='_blank'><Image src={ linkedinSVG } className={`${styles.social_media} ${styles.linkedinSVG}`} alt='LinkedIn-Logo' /></Link>
              </div>

              <div className={`${styles.social_media_logo_wrapper} ${styles.twitterSVG_wrapper}`}>
                <Link href='https://twitter.com/stevVIEsprotest/' target='_blank'><Image src={ twitterSVG } className={`${styles.social_media} ${styles.twitterSVG}`} alt='Twitter-Logo' /></Link>
              </div>

              <div className={`${styles.social_media_logo_wrapper} ${styles.youtubeSVG_wrapper}`}>
                <Link href='https://www.youtube.com/channel/UCVUfjupaBJzqm4JfgWllumQ/about' target='_blank'><Image src={ youtubeSVG } className={`${styles.social_media} ${styles.youtubeSVG}`} alt='Youtube-Logo' /></Link>
              </div>
